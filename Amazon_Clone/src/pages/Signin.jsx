...
//                 <input className="w-full lowercase py-1 border-zinc-400 px-2 text-base rounded-sm outline-none 
//                 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent"type="email"/>
//             </div>
//             <div className='flex flex-col gap-2'>
//                 <p className='text-sm font-medium'>Password</p>
//                 <input  className="w-full lowercase py-1 border-zinc-400 px-2 text-base rounded-sm outline-none 
//                 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent" type="password"/>
//             </div>
//             <button onClick={(e)=>e.preventDefault()} className='w-full py-1.5 text-sm font-normal rounded-sm bg-gradient-to-t from-[#f7dfa5] to-[#f0c14b] hover:bg-gradient-to-b border border-zinc-400 active:border-yellow-800 active:shadow-amazonInput'>Continue
//             </button>
//         </div>
...
//         <p className='text-xs text-gray-600 mt-6 cursor-pointer group'><ArrowRightIcon/><span className= 'text-blue-600 group-hover:text-red-700 group-hover:underline-offset-1'>Need help?</span></p>
//         </div>
...
//             <p className='text-xs text-blue-600 hover:text-orange-600 hover:underline underline-offset-1 cursor-pointer duration-100'>Privacy Notice</p>
//         </div>
//         <p className='text-xs texy-gray-600'>© 1996-2023, ReactBd.com, Inc. or its affiliates</p>
//       </div>
//     </div>
//   )
// }
...
//           setUserPassErr("Invalid Email");
//         }
//         if(errorCode.includes("auth/invalid-email")){
//           setUserPassErr("Wrong password!try again");
//         }
//         console.log("Something is up,try with correct crendential");
